                ...
                <div class="mx-auto py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="seksi" class="block mt-1 w-full" type="text" name="seksi" :value="old('seksi')" required autofocus autocomplete="seksi" />
                            <x-input-error :messages="$errors->get('seksi')" class="mt-2" />
                        </div>
                        <div class="mt-4">
                            <x-input-label for="no_wa" :value="__('No. Whatsapp')" />
                            <x-text-input id="no_wa" class="block mt-1 w-full" type="text" name="no_wa" :value="old('no_wa')" required autocomplete="no_wa" />
